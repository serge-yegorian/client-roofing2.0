            ...
            <main className='home'>
                <section className='home__section home__section--flex'>
                    <div className='home__container home__container--black'>
                        <div>
                        <h1 className='home__heading'>Optimum Roofing & Contruction</h1>
                ...
                <section className='home__section home__section--accent'>
                    <div className='home__container'>
                        <div className='home__testimonial'>
                            ...
                            <p className='home__description'>Collaborating with Optimum Roofing Solutions has been life-changing.<br/><br/> Their design prowess and attentive service truly stand out.<br/><br/> For extraordinary home transformations, Optimum Roofing Solutions is the ultimate choice!</p>
                            <h4 className='home__testimonial-date'>July 2023</h4>
                        </div>
                        <div className='home__testimonial'>
                            ...
                            <h4 className='home__testimonial-date'>August 2023</h4>
                        </div>
                        <div className='home__testimonial'>
                            ...
                            <h4 className='home__testimonial-date'>June 2023</h4>
                        </div>
                        {/* <div className='home__testimonial'>
